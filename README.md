...
1. 从 [GitHub Releases](https://github.com/TensorHub-ORG/Coomi-Android/releases) 或[官网](https://coomi.septemc.com/)下载最新 APK（`Coomi-Android-arm64-v1.2.6-fix.apk`），安装到 Android 7.0+ 的 ARM64 设备。
